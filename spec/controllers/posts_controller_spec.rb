describe PostsController do
  ...
  describe '#destroy' do
    context 'neither admin or post owner' do
      before do
        sign_in!
      end
      
      it 'does not allow the request' do
        destroy_post = create(:post, content: 'bar')

        expect { delete :destroy, id: destroy_post.id}.not_to change(Post, :count)
      end
    end 
    ...
    context 'admin' do
      ...
      it 'allows the request' do
        ...
        expect { delete :destroy, :id => destroy_post.id}.to change(Post, :count)
      end
    end
  end    
end
